...
class VideoRenderer(resources: Resources) : GLSurfaceView.Renderer {
    private val OM: FloatArray

    */
/**显示画面的filter *//*

    private val showFilter: AFilter

    */
/**后台绘制的filter *//*

    private val drawFilter: AFilter
...
/**用于绘制美白效果的filter *//*
    ...
    private val mProcessFilter: AFilter
...
/**控件的宽高 *//*
    ...
    private fun addFilter(filter: AFilter) {
        */
/**抵消本身的颠倒操作 *//*
...
/**创建显示的texture *//*
    ...
    init {
        //初始化一个滤镜 也可以叫控制器
        showFilter = NoFilter(resources)
        drawFilter = CameraFilter(resources)
        mProcessFilter = ProcessFilter(resources)
        ...
        val waterMarkFilter = WaterMarkFilter(resources)
